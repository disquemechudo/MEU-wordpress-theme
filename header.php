...
<button class="btn" id="logout-button" id="wp-admin-bar-logout"><a class="ab-item" href="http://mobile-eyes-us.itp.io:8000/wp-login.php?action=logout&#038;_wpnonce=af61cc7803">Log Out</a>		</button>
